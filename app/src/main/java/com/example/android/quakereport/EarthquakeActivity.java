...
public class EarthquakeActivity extends AppCompatActivity
    ...
    private static final String USGS_JSON_URL = "https://earthquake.usgs.gov/fdsnws/event/1/query";
    ...
    public Loader<List<Terremoto>> onCreateLoader(int i, Bundle bundle) {
        ...
        String limit = sharedPrefs.getString(
                getString(R.string.settings_how_many_key),
                getString(R.string.settings_how_many_default));
        Uri baseUri = Uri.parse(USGS_JSON_URL);
