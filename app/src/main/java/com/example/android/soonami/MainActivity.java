    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e(LOG_TAG,"Errore facendo la richiesta: "+e);
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            String jsonResponse = "";
            //verificiamo che url non sia vuoto. Se è vuoto, inutile procedere
            if (url == null) {
                return jsonResponse;
            }
            ...
            try {
                ...
                //se connessione ok, allora si prosegue
                if (responseCode==HTTP_OK) {
                    inputStream = urlConnection.getInputStream();
                    jsonResponse = readFromStream(inputStream);
                }
            } catch (IOException e) {
                Log.e(LOG_TAG,"Errore scaricando i dati: "+e);
            } finally {
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            //vediamo se il json passato contiene dei dati, altrimenti inutile continuare
